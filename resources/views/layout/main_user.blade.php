...
<head>
    ...
    <link href="{{asset('template_user/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css')}}" rel="stylesheet" />
...
<body>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Jl. Cengger Ayam Dalam 1, Malang</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+6243456789012</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>elfasyazidan1@gmail.com</p>
    ...
    <script src="{{asset('template_user/lib/tempusdominus/js/moment.min.js')}}"></script>
    <script src="{{asset('template_user/lib/tempusdominus/js/moment-timezone.min.js')}}"></script>
    <script src="{{asset('template_user/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js')}}"></script>
